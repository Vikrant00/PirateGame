...
FPirateMCPBlueprintCommands::FPirateMCPBlueprintCommands()
{
}

TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleCommand(const FString& CommandType, const TSharedPtr<FJsonObject>& Params)
{
    ...
    return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Unknown blueprint command: %s"), *CommandType));
}

TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleCreateBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    ...
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Blueprint already exists: %s"), *BlueprintName));
    }
    ...
    if (!ParentClass.IsEmpty())
    {
        ...
        if (FoundClass)
        {
            ...
            UE_LOG(LogPirateMCP, Log, TEXT("Successfully set parent class to '%s'"), *ClassName);
        }
        else
        {
            UE_LOG(LogPirateMCP, Warning, TEXT("Could not find specified parent class '%s' at paths: /Script/Engine.%s or /Script/Game.%s, defaulting to AActor"), 
    ...
    return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Failed to create blueprint"));
}

TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleAddComponentToBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    ...
    // Find the blueprint
    UBlueprint* Blueprint = FPirateMCPCommonUtils::FindBlueprint(BlueprintName);
    if (!Blueprint)
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Blueprint not found: %s"), *BlueprintName));
    }
    ...
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Unknown component type: %s"), *ComponentType));
    }
    ...
    if (NewNode)
    {
        ...
        if (SceneComponent)
        {
            ...
            {
                SceneComponent->SetRelativeLocation(FPirateMCPCommonUtils::GetVectorFromJson(Params, TEXT("location")));
            }
            if (Params->HasField(TEXT("rotation")))
            {
                SceneComponent->SetRelativeRotation(FPirateMCPCommonUtils::GetRotatorFromJson(Params, TEXT("rotation")));
            }
            if (Params->HasField(TEXT("scale")))
            {
                SceneComponent->SetRelativeScale3D(FPirateMCPCommonUtils::GetVectorFromJson(Params, TEXT("scale")));
            }
        }
    ...
    return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Failed to add component to blueprint"));
}

TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleSetPhysicsProperties(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    ...
    if (!Params->TryGetStringField(TEXT("component_name"), ComponentName))
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'component_name' parameter"));
    }
    ...
    if (!ComponentNode)
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Component not found: %s"), *ComponentName));
    }

    UPrimitiveComponent* PrimComponent = Cast<UPrimitiveComponent>(ComponentNode->ComponentTemplate);
    if (!PrimComponent)
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Component is not a primitive component"));
    }
    ...
    if (Params->HasField(TEXT("mass")))
    {
        ...
        UE_LOG(LogPirateMCP, Display, TEXT("Set mass for component %s to %f kg"), *ComponentName, Mass);
    }
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleCompileBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleSpawnBlueprintActor(const TSharedPtr<FJsonObject>& Params)
{
    UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: Starting blueprint actor spawn"));
    
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
        UE_LOG(LogPirateMCP, Error, TEXT("HandleSpawnBlueprintActor: Missing blueprint_name parameter"));
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'blueprint_name' parameter"));
    }
    ...
    {
        UE_LOG(LogPirateMCP, Error, TEXT("HandleSpawnBlueprintActor: Missing actor_name parameter"));
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'actor_name' parameter"));
    }

    UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: Looking for blueprint '%s'"), *BlueprintName);

    // Find the blueprint
    UBlueprint* Blueprint = FPirateMCPCommonUtils::FindBlueprint(BlueprintName);
    if (!Blueprint)
    {
        UE_LOG(LogPirateMCP, Error, TEXT("HandleSpawnBlueprintActor: Blueprint not found: %s"), *BlueprintName);
        return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Blueprint not found: %s"), *BlueprintName));
    }

    UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: Blueprint found, getting transform parameters"));
    ...
    if (Params->HasField(TEXT("location")))
    {
        ...
        UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: Location set to (%f, %f, %f)"), Location.X, Location.Y, Location.Z);
    }
    if (Params->HasField(TEXT("rotation")))
    {
        Rotation = FPirateMCPCommonUtils::GetRotatorFromJson(Params, TEXT("rotation"));
        UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: Rotation set to (%f, %f, %f)"), Rotation.Pitch, Rotation.Yaw, Rotation.Roll);
    }

    UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: Getting editor world"));

    // Spawn the actor
    UWorld* World = GEditor->GetEditorWorldContext().World();
    if (!World)
    {
        UE_LOG(LogPirateMCP, Error, TEXT("HandleSpawnBlueprintActor: Failed to get editor world"));
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Failed to get editor world"));
    }

    UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: Creating spawn transform"));
    ...
    UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: About to spawn actor from blueprint '%s' with GeneratedClass: %s"), 
    ...
    UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: SpawnActor completed, NewActor: %s"), 
           NewActor ? *NewActor->GetName() : TEXT("NULL"));
    
    if (NewActor)
    {
        UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: Setting actor label to '%s'"), *ActorName);
        NewActor->SetActorLabel(*ActorName);
        
        UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: About to convert actor to JSON"));
        TSharedPtr<FJsonObject> Result = FPirateMCPCommonUtils::ActorToJsonObject(NewActor, true);
        
        UE_LOG(LogPirateMCP, Warning, TEXT("HandleSpawnBlueprintActor: JSON conversion completed, returning result"));
        return Result;
    }

    UE_LOG(LogPirateMCP, Error, TEXT("HandleSpawnBlueprintActor: Failed to spawn blueprint actor"));
    return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Failed to spawn blueprint actor"));
}

TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleSetStaticMeshProperties(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    ...
    if (!MeshComponent)
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Component is not a static mesh component"));
    }
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleSetMeshMaterialColor(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    ...
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("'color' must be an array of 4 float values [R, G, B, A]"));
    }
    ...
    if (Params->TryGetStringField(TEXT("material_path"), MaterialPath))
    {
        ...
        if (!Material)
        {
            return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Failed to load material: %s"), *MaterialPath));
        }
    }
    else
    {
        ...
        if (!Material)
        {
            ...
            if (!Material)
            {
                return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("No material found on component and failed to load default material"));
            }
        }
    }
    ...
    if (!DynMaterial)
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Failed to create dynamic material instance"));
    }
    ...
    // Log success
    UE_LOG(LogPirateMCP, Log, TEXT("Successfully set material color on component %s: R=%f, G=%f, B=%f, A=%f"), 
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleGetAvailableMaterials(const TSharedPtr<FJsonObject>& Params)
{
    ...
    if (!SearchPath.IsEmpty())
    {
        ...
        UE_LOG(LogPirateMCP, Log, TEXT("Searching for materials in: %s"), *SearchPath);
    }
    else
    {
        // Search in common game content locations
        Filter.PackagePaths.Add(TEXT("/Game/"));
        UE_LOG(LogPirateMCP, Log, TEXT("Searching for materials in all game content"));
    }
    
    if (bIncludeEngineMaterials)
    {
        Filter.PackagePaths.Add(TEXT("/Engine/"));
        UE_LOG(LogPirateMCP, Log, TEXT("Including Engine materials in search"));
    }
    ...
    UE_LOG(LogPirateMCP, Log, TEXT("Asset registry found %d materials"), AssetDataArray.Num());
    ...
    UE_LOG(LogPirateMCP, Log, TEXT("Total materials found after manual search: %d"), AssetDataArray.Num());
    ...
    for (const FAssetData& AssetData : AssetDataArray)
    {
        ...
        UE_LOG(LogPirateMCP, Verbose, TEXT("Found material: %s at %s"), *AssetData.AssetName.ToString(), *AssetData.GetObjectPathString());
    }
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleApplyMaterialToActor(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString ActorName;
    if (!Params->TryGetStringField(TEXT("actor_name"), ActorName))
    ...
    if (!Params->TryGetStringField(TEXT("material_path"), MaterialPath))
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'material_path' parameter"));
    }
    ...
    if (!bAppliedToAny)
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("No mesh components found on actor"));
    }
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleApplyMaterialToBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleGetActorMaterialInfo(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString ActorName;
    if (!Params->TryGetStringField(TEXT("actor_name"), ActorName))
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleGetBlueprintMaterialInfo(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    ...
    else
    {
        ...
        UE_LOG(LogPirateMCP, Warning, TEXT("No static mesh assigned to component %s in blueprint %s"), *ComponentName, *BlueprintName);
    }
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleReadBlueprintContent(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintPath;
    if (!Params->TryGetStringField(TEXT("blueprint_path"), BlueprintPath))
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'blueprint_path' parameter"));
    }
    ...
    if (!Blueprint)
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Failed to load blueprint: %s"), *BlueprintPath));
    }
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleAnalyzeBlueprintGraph(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintPath;
    if (!Params->TryGetStringField(TEXT("blueprint_path"), BlueprintPath))
    ...
    if (!TargetGraph)
    {
        return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Graph not found: %s"), *GraphName));
    }
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleGetBlueprintVariableDetails(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintPath;
    if (!Params->TryGetStringField(TEXT("blueprint_path"), BlueprintPath))
    ...
    if (bSpecificVariable)
    {
        ...
        {
            return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Variable not found: %s"), *VariableName));
        }
    }
    else
    {
...
TSharedPtr<FJsonObject> FPirateMCPBlueprintCommands::HandleGetBlueprintFunctionDetails(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintPath;
    if (!Params->TryGetStringField(TEXT("blueprint_path"), BlueprintPath))
    ...
    if (bSpecificFunction)
    {
        ...
        {
            return FPirateMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Function not found: %s"), *FunctionName));
        }
    }
    else
    {
